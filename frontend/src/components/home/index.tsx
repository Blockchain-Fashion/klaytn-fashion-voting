  ...
  return (
    <>
      ...
      {!isLoadingFetchList && data && data.length > 0 && (
        <>
          <div className="z-10 mt-5 font-bold">TOTAL DEPOSITED: {dataTotalVote} FCT</div>
      ...
      <div className="z-10 my-5 grid w-full max-w-screen-xl grid-cols-1 gap-5 px-5 md:grid-cols-3 xl:px-0">
        {data &&
          data.length > 0 &&
          data.map(({ name, images, amountVote, avatar }, index) => (
            <a
              ...
              style={{ backgroundImage: `url(${avatar})`, height: '500px' }}
            >
